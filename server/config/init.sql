...
(
    ...
    short_title character varying(3),
    description character varying(200),
    color_theme integer,
    categories character varying(10)[] DEFAULT '{default}'::character varying[],
    redirict character varying,
