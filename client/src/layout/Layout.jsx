...
const Layout = ({ children, title, loading }) => {
  return (
    <>
      <Helmet>
        <meta charSet="utf-8" />
        <title>{title || "Home"} | Main Store </title>
        <meta
          name="description"
        ...
        <meta property="og:title" content="Main Store" />
        <meta
          property="og:description"
          content="Ecommerce store built with React, Node, Express and Postgres"
        />
        <meta property="og:url" content="http://localhost:3000/" />
        <meta property="og:site_name" content="Main Store" />
        ...
        <meta
          ...
          content="Ecommerce store built with React, Node, Express and Postgres"
        />
        <meta name="twitter:title" content="Main Store" />
      ...
      <div className="min-h-screen flex flex-col">
        ...
        <footer className="mt-auto flex justify-center py-2">
          <p className="text-sm text-gray-600 sm:ml-4 sm:pl-4 sm:py-2 sm:mt-0 mt-4">
            © 2021 Main Store —
            <a
              href="https://github.com/Kosh4tina"
